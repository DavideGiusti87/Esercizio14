...
public class Badge {
    ...
    private String generateBadgeIdCode(){
        return "ASD"+employee.name+employee.surname+"DSA";
    }
    public void showBadgeDetails(){
        System.out.printf("Employees tracked: %d%n" +
                "Employee details - %s%n" +
                "Badge number: %s%n",totalNumberOfEmployees,employee.getEmployeeDetails(),badgeIdCode);
    }
}
